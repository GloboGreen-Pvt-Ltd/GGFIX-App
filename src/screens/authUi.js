...
export function ErrorBox({ msg }) {
  ...
  return (
    ...
    >
      <Text style={{ fontSize: rf(12.5), color: '#B91C1C', lineHeight: rlh(18) }}>{msg}</Text>
    </View>
  );
}

export const authStyles = {
  h1: { fontSize: rf(24), fontWeight: '800', color: INK, letterSpacing: -0.4 },
  sub: { fontSize: rf(13.5), color: MUTED, marginTop: 6, lineHeight: rlh(20) },
  fieldLabel: { fontSize: rf(12), fontWeight: '600', color: INK, marginBottom: 6, marginTop: 18, marginLeft: 2 },
  fieldRow: {
    flexDirection: 'row',
    alignItems: 'center',
  ...
  fieldInput: { fontSize: rf(15), color: INK, height: '100%', paddingVertical: 0 },
  ccChip: {
    flexDirection: 'row',
    alignItems: 'center',
    paddingRight: 10,
  ...
  ccText: { fontSize: rf(14), fontWeight: '700', color: INK },
  link: { fontSize: rf(13), fontWeight: '700', color: GREEN },
};
