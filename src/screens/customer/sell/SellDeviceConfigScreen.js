        ...
        {fields.map((f) => {
          ...
          return (
            <View key={f.id} className="mb-3">
              <Card padded={false}>
                <View className="p-4">
                  <Text className="font-extrabold text-text mb-2" style={{ fontSize: rf(13) }}>{f.name}</Text>
                  <Pressable
                  ...
                  >
                    <Text className={`flex-1 ${sel ? 'text-text font-bold' : 'text-text-subtle'}`} style={{ fontSize: rf(13) }} numberOfLines={1}>
                  ...
                  <View className="border-t border-border">
                    {opts.map((o, idx) => {
                      ...
                      return (
                        ...
                        >
                          <Text className={`flex-1 ${active ? 'text-primary font-extrabold' : 'text-text'}`} style={{ fontSize: rf(13) }}>{o.value}</Text>
