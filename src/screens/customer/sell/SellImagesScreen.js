...
const styles = StyleSheet.create({
  ...
  slotLabelOverlay: { position: 'absolute', bottom: 0, left: 0, right: 0, backgroundColor: 'rgba(255,255,255,0.92)', paddingVertical: 4, fontSize: rf(12), fontWeight: '700', color: colors.text, textAlign: 'center' },
    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={{ padding: 12 }}>
        ...
        <Card style={{ padding: 10, marginVertical: 4 }}>
          <Text style={{ fontSize: rf(14), fontWeight: '700', color: colors.text, marginBottom: 4, textAlign: 'center' }}>Upload for Device Images</Text>
          <Text style={{ fontSize: rf(11), color: colors.textSecondary, marginBottom: 8, textAlign: 'center' }}>Maximum file size: 5 MB.</Text>
