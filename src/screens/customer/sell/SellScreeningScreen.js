...
const styles = StyleSheet.create({
  ...
  qTitle: { fontSize: rf(13), fontWeight: '700', color: colors.text },
  qHelp: { fontSize: rf(11), color: colors.textSecondary, marginTop: 2 },
  ...
  ansLabel: { marginLeft: 8, fontSize: rf(13), color: colors.text },
