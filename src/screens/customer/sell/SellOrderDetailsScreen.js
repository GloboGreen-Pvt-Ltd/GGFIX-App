...
const styles = StyleSheet.create({
  ...
  deviceCard: { borderColor: '#004C40', borderWidth: 1 },
  summaryCard: { borderColor: '#2563EB', borderWidth: 1 },
  customerCard: { borderColor: '#004C40', borderWidth: 1 },
  body: { flexDirection: 'row' },
  modelName: { fontSize: rf(16), fontWeight: '700', color: colors.text },
  small: { fontSize: rf(13), color: colors.text, marginTop: 2 },
  thumb: { width: 80, height: 90, borderRadius: 8, backgroundColor: '#E5E7EB', marginLeft: 12 },
  photoHeading: { fontSize: rf(12), fontWeight: '700', color: colors.text, marginTop: 10, marginBottom: 6 },
  ...
  heading: { fontSize: rf(14), fontWeight: '700', color: '#2563EB', marginBottom: 8 },
  subHeading: { fontSize: rf(13), fontWeight: '700', color: colors.text, marginTop: 10, marginBottom: 2 },
  itemRow: { flexDirection: 'row', alignItems: 'flex-start', marginTop: 5 },
  itemText: { marginLeft: 6, fontSize: rf(12), color: colors.text, flex: 1, lineHeight: rlh(16) },
  custRow: { flexDirection: 'row', alignItems: 'flex-start', marginTop: 6 },
  custText: { marginLeft: 8, fontSize: rf(13), color: colors.text, flex: 1, lineHeight: rlh(18) },
  ...
  statusBannerText: { color: '#92400E', fontWeight: '700', marginLeft: 6, fontSize: rf(12) },
});
...
function Check() {
  return <Ionicons name="checkmark-circle-outline" size={15} color="#004C40" style={{ marginTop: 1 }} />;
}
      ...
      <ScrollView contentContainerStyle={{ padding: 12, paddingBottom: 24 }}>
        ...
        {address ? (
          <Card style={styles.customerCard}>
            <Text style={[styles.heading, { color: '#004C40' }]}>Customer Details</Text>
            <View style={styles.custRow}>
              <Ionicons name="person-outline" size={16} color="#004C40" style={{ marginTop: 1 }} />
              <Text style={styles.custText}>{[address.fullName, phone].filter(Boolean).join('  |  ')}</Text>
            </View>
            <View style={styles.custRow}>
              <Ionicons name="location-outline" size={16} color="#004C40" style={{ marginTop: 1 }} />
