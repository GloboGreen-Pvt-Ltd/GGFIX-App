...
// Shop KYC documents removed — owner KYC now lives on users.kyc_document
// (auth-service /auth/me/kyc-documents); the per-shop shop_kyc_documents
// table and its endpoints are retired.
