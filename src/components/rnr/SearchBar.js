...
export function SearchBar({
  ...
  return (
    ...
    >
      ...
      {onPress ? (
        <Text className="flex-1 ml-2.5 text-text-muted" style={{ fontSize: rf(14) }}>{placeholder}</Text>
      ) : (
        <TextInput
          value={value}
          ...
          editable={editable}
          autoFocus={autoFocus}
          className="flex-1 ml-2.5 text-text"
          style={{ paddingVertical: 0, fontSize: rf(14) }}
        />
      )}
      {value ? (
